...
plot_N <- ggplot() + 
  ...
  ggtitle("C")
#N forcing y2 plot
Sled_WSA2$Date <- as.POSIXct(c("2019-02-06 23:0:0", "2019-03-14 23:0:0", "2019-04-14 23:0:0", "2019-05-02 23:0:0", "2019-05-23 23:0:0"))
...
# Scott's fix: RomePt_WSA2 was missing, so we'll create this with expected values:
RomePt_WSA2 <- filter(WSA_Y2, Site == "Rome Point") #filter by site
RomePt_WSA2$NO3NO2_µM <- RomePt_WSA2$NO3NO2_µM/1000000 #convert from micromoles/L to moles/L
RomePt_WSA2$Date <- as.POSIXct(c("2018-12-12 23:0:0", "2019-02-21 23:0:0", "2019-03-13 23:0:0", "2019-05-23 23:0:0"))
